...
namespace Ghost.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(GhostContext context)
        {
            _context = context;
        }

        // GET: Teachers
        public async Task<IActionResult> Index(string searchName,string searchDegree,string searchRank)
        {
            ViewData["SD"] = searchDegree;
            ViewData["SN"] = searchName;
            ViewData["SR"] = searchRank;
